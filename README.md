...
Logging is implemented using [Napier](https://github.com/AAkira/Napier). Use `Napier.d("message")` to log debug
messages.

A bit more in detail (copied from the docs):
...
You can also use top-level function (though this didn't work for me)
